...
public class Vector {
    ...
    /**
     * Converts a Vector to a Raylib Vector2.
     * @return a Raylib Vector2.
     */
    public Vector2 toRaylibVector2(){
     ...
     * @return a Raylib Vector2.
     */
    public static Vector2 toRaylibVector2(Vector vector){
        return new Vector2().x((float) vector.x).y((float) vector.y);
    }
